...
export default class Game {
    constructor(canvas, ctx, worldNum, levelNum, game) {
        this.canvas = canvas;
        this.ctx = ctx;
    ...
    gameOver(gameLoop) {
        ...
        this.menu = new GameMenu(this.canvas, this.ctx,"failed",this.worldNum, this.levelNum, this.game).open();
    }

    levelComplete(gameLoop) {
        this.interactables = [];
        clearInterval(gameLoop);
        this.menu = new GameMenu(this.canvas, this.ctx, "complete", this.worldNum, this.levelNum, this.game).open();
    }
